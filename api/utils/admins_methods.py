...
async def get_order_info(order_id: int) -> AdminOrderInfoResponse:
    ...
    return AdminOrderInfoResponse(
        ...
        title=order.title,
        source_of_truth=order.source_of_truth,
        site_or_app=order.site_or_app,
        customer_identity=order.customer_identity,
        violation_proof_requirements=order.violation_proof_requirements,
        additional_requirements=order.additional_requirements,
        contact_free_deal=order.contact_free_deal,
        task_free_deal=order.task_free_deal,
        how_to_proove_free_deal=order.how_to_proove_free_deal,
        slug=order.slug,
        price=order.price,
        status=order.status,
