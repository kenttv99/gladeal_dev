...
EXPIRES_PAYMENT_TIME_MINUTES = getenv("EXPIRES_PAYMENT_TIME_MINUTES")
EXPIRES_PAYOUT_TIME_MINUTES = getenv("EXPIRES_PAYOUT_TIME_MINUTES")
...
if not EXPIRES_PAYMENT_TIME_MINUTES:
    raise RuntimeError("EXPIRES_PAYMENT_TIME_MINUTES is not set")

if not EXPIRES_PAYOUT_TIME_MINUTES:
    raise RuntimeError("EXPIRES_PAYOUT_TIME_MINUTES is not set")
...
EXPIRES_PAYMENT_TIME_MINUTES = int(EXPIRES_PAYMENT_TIME_MINUTES)
EXPIRES_PAYOUT_TIME_MINUTES = int(EXPIRES_PAYOUT_TIME_MINUTES)
