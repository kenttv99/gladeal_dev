...
SMS_CALLS_SEND_ATTEMPTS_LIMIT = getenv("SMS_CALLS_SEND_ATTEMPTS_LIMIT")
SMS_CALLS_SEND_LIMIT_PAUSE_MINUTES = getenv("SMS_CALLS_SEND_LIMIT_PAUSE_MINUTES")
SMS_CALLS_VERIFY_ATTEMPTS_LIMIT = getenv("SMS_CALLS_VERIFY_ATTEMPTS_LIMIT")
...
if not SMS_CALLS_SEND_ATTEMPTS_LIMIT:
    raise RuntimeError("SMS_CALLS_SEND_ATTEMPTS_LIMIT is not set")

if not SMS_CALLS_SEND_LIMIT_PAUSE_MINUTES:
    raise RuntimeError("SMS_CALLS_SEND_LIMIT_PAUSE_MINUTES is not set")

if not SMS_CALLS_VERIFY_ATTEMPTS_LIMIT:
    raise RuntimeError("SMS_CALLS_VERIFY_ATTEMPTS_LIMIT is not set")
...
SMS_CALLS_SEND_ATTEMPTS_LIMIT = int(SMS_CALLS_SEND_ATTEMPTS_LIMIT)
SMS_CALLS_SEND_LIMIT_PAUSE_MINUTES = int(SMS_CALLS_SEND_LIMIT_PAUSE_MINUTES)
SMS_CALLS_VERIFY_ATTEMPTS_LIMIT = int(SMS_CALLS_VERIFY_ATTEMPTS_LIMIT)
SMS_CALLS_SEND_LIMIT_PAUSE_SECONDS = SMS_CALLS_SEND_LIMIT_PAUSE_MINUTES * 60
